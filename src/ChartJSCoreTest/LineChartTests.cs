...
namespace ChartJSCoreTest
{
    ...
    {
        private const string KNOWN_GOOD_CHART = "var lineChartElement = document.getElementById(\"lineChart\");\r\nvar lineChart = new Chart(lineChartElement, {\"type\":\"line\",\"data\":{\"datasets\":[{\"type\":\"line\",\"pointBackgroundColor\":\"rgba(255, 255, 255, 1)\",\"pointBorderColor\":\"rgba(75, 192, 192, 1)\",\"pointBorderWidth\":1,\"pointHitRadius\":10,\"pointRadius\":1,\"borderCapStyle\":\"butt\",\"borderDash\":[],\"borderDashOffset\":0.0,\"borderJoinStyle\":\"miter\",\"fill\":false,\"tension\":0.1,\"spanGaps\":false,\"pointHoverBackgroundColor\":\"rgba(75, 192, 192, 1)\",\"pointHoverBorderColor\":\"rgba(220, 220, 220, 1)\",\"pointHoverBorderWidth\":2,\"pointHoverRadius\":5,\"backgroundColor\":\"rgba(75, 192, 192, 0.4)\",\"borderColor\":\"rgba(75, 192, 192, 1)\",\"data\":[65.0,59.0,80.0,81.0,56.0,55.0,40.0],\"label\":\"My First dataset\"}],\"labels\":[\"January\",\"February\",\"March\",\"April\",\"May\",\"June\",\"July\"]},\"options\":{\"scales\":{\"y\":{\"ticks\":{\"callback\":function(value, index, values) {return '$' + value;}}}}}}\r\n);";
