...
namespace ChartJSCoreTest
{
    ...
    {
        private const string KNOWN_GOOD_CHART = "var radarChartElement = document.getElementById(\"radarChart\");\r\nvar radarChart = new Chart(radarChartElement, {\"type\":\"radar\",\"data\":{\"datasets\":[{\"type\":\"radar\",\"pointBackgroundColor\":\"rgba(179, 181, 198, 1)\",\"pointBorderColor\":\"rgba(255, 255, 255, 1)\",\"pointHoverBackgroundColor\":\"rgba(255, 255, 255, 1)\",\"pointHoverBorderColor\":\"rgba(179, 181, 198, 1)\",\"backgroundColor\":\"rgba(179, 181, 198, 0.2)\",\"borderColor\":\"rgba(179, 181, 198, 1)\",\"data\":[65.0,59.0,null,81.0,56.0,55.0,40.0],\"label\":\"My First dataset\"},{\"type\":\"radar\",\"pointBackgroundColor\":\"rgba(255, 99, 132, 1)\",\"pointBorderColor\":\"rgba(255, 255, 255, 1)\",\"pointHoverBackgroundColor\":\"rgba(255, 255, 255, 1)\",\"pointHoverBorderColor\":\"rgba(255, 99, 132, 1)\",\"backgroundColor\":\"rgba(255, 99, 132, 0.2)\",\"borderColor\":\"rgba(255, 99, 132, 1)\",\"data\":[28.0,48.0,40.0,null,96.0,27.0,100.0],\"label\":\"My Second dataset\"}],\"labels\":[\"Eating\",\"Drinking\",\"Sleeping\",\"Designing\",\"Coding\",\"Cycling\",\"Running\"]},\"options\":{}}\r\n);";
